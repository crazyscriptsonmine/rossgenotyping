...
my $files = `for i in \$(ls -1 ../ALLSNPS/*/hetero*txt); 
do 
...
echo perl ~/SCRIPTS/rossgenotyping/07-htrzygty_window.pl -t \$i -f ~/.big_ten/Galgal5/Galgal-5.fa -w 20000 -s 10000 -o \$d\\_\$c-20_10.txt;
echo perl ~/SCRIPTS/rossgenotyping/07-htrzygty_window.pl -t \$i -f ~/.big_ten/Galgal5/Galgal-5.fa -w 30000 -s 15000 -o \$d\\_\$c-30_15.txt;
echo perl ~/SCRIPTS/rossgenotyping/07-htrzygty_window.pl -t \$i -f ~/.big_ten/Galgal5/Galgal-5.fa -w 40000 -s 20000 -o \$d\\_\$c-40_20.txt;
done`;
